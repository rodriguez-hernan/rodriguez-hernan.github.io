...
function renderPostList() {
  ...
  postList.forEach( post => {
    ...
    titleNode.setAttribute("class", "post__title");
    let titleText = document.createTextNode(post.title);
    titleNode.appendChild(titleText);

    let contentNode = document.createElement("P");
    contentNode.setAttribute("class", "post__content");
    let contentText = document.createTextNode(post.content);
    contentNode.appendChild(contentText);

    let buttonNode = document.createElement("BUTTON");
    buttonNode.setAttribute("class", "post__button");
    buttonNode.setAttribute("onclick", "removePost()");
    let contentText = document.createTextNode(post.content);
    contentNode.appendChild(contentText);
